...
import { Project, ProjectWork, CustomSubmissionType } from '../types';
import {
  Calendar,
  Layers,
  Hash,
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Your Daily Status Report has been compiled and recorded under <strong>{currentUserEmail}</strong>.
            </p>
          </div>
